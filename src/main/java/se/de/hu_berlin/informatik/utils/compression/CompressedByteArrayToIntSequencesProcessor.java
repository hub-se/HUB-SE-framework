 ...
 * @author Simon Heiden
 */
public class CompressedByteArrayToIntSequencesProcessor extends AbstractProcessor<byte[],List<List<Integer>>> {
	...
	public CompressedByteArrayToIntSequencesProcessor() {
		super();
	}
