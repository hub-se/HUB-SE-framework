 ...
 * @author Simon Heiden
 */
public class ExecuteCommandInSystemEnvironmentAndReturnOutput extends AbstractProcessor<String[],String> {
	 ...
	 */
	public ExecuteCommandInSystemEnvironmentAndReturnOutput(File executionDir, boolean returnErrorOutput, String... paths) {
		super();
	 ...
	 */
	public ExecuteCommandInSystemEnvironmentAndReturnOutput setExecutionDir(File executionDir) {
		this.executionDir = executionDir;
		return this;
	}
	 ...
	 * this module for method chaining
	 */
	public ExecuteCommandInSystemEnvironmentAndReturnOutput setEnvVariable(String variable, String value) {
