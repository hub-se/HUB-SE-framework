 ...
 * @author Simon Heiden
 */
public class ByteArrayToCompressedByteArrayModule extends AbstractProcessor<byte[],byte[] > {
	...
	public ByteArrayToCompressedByteArrayModule(int maxValue, int sequenceLength) {
		super();
