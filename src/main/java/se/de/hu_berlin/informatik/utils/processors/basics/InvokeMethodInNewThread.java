 ...
 * @author Simon Heiden
 */
public class InvokeMethodInNewThread extends AbstractProcessor<Object[],Thread> {
	...
	public InvokeMethodInNewThread(Object caller, final String className, final String methodName, Class<?> argType, boolean waitForFinish) {
		super();
		this.caller = caller;
