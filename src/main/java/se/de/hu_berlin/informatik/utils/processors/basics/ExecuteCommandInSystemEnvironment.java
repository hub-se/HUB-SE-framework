 ...
 * @author Simon Heiden
 */
public class ExecuteCommandInSystemEnvironment extends AbstractProcessor<String[],Integer> {
	 ...
	 */
	public ExecuteCommandInSystemEnvironment(File executionDir, String... paths) {
		super();
	 ...
	 */
	public ExecuteCommandInSystemEnvironment setExecutionDir(File executionDir) {
		this.executionDir = executionDir;
		return this;
	}
	 ...
	 * this module for method chaining
	 */
	public ExecuteCommandInSystemEnvironment setEnvVariable(String variable, String value) {
