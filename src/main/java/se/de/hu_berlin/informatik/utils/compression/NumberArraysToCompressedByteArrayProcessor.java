 ...
 * @author Simon Heiden
 */
public class NumberArraysToCompressedByteArrayProcessor<T extends Number> extends AbstractProcessor<T[],byte[] > {
	...
	public NumberArraysToCompressedByteArrayProcessor(int maxValue, int sequenceLength) {
		super();
